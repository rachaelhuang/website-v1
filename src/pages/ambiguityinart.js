    ...
    <div className="case-study">
      ...
      <section className="final-product-teaser">
        ...
        <video autoPlay loop muted className="case-study-video">
          <source src="/assets/ambiguityinart/ambiguityinart_demovid1.mp4" type="video/mp4" /> </video>
      </section>
      ...
      <h3>User interviews</h3>
        ...
        <h3>Data analysis</h3>
            ...
            <img src="../assets/ambiguityinart/empathymaps.png" className="empathy-maps"/>

            <li> <strong>Sharing with friends</strong> makes a user's experience more enjoyable, such as sharing insights across social media apps. One example is how Spotify stats show an “an emblem of you”. This feature can get more people to come to the museum</li>
            <li> Summary stats more satisfying to receive all at end, higher anticipation, also more accurate depiction when more data to present vs. one at a time with minimal data. slideshow recap of what you viewed/your interpretations in addition to comparative stats</li>
            ...
            <li>short blurbs more well liked but do we include blurbs or not? - does this sway views early on?</li>
